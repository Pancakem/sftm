...
view : a -> Model -> {title : String, content : Html a}
view msg model =
    let
        startShape =
         ...
         , content =
            ...
            , div [ id "scrolling", class "proof" ]
                [ div [ class "proof-body" ]
                    [ div [ class "proof-description" ] [ text <| "Problem " ++ String.fromInt (model.index + 1) ++ ": " ++ model.name ]
...
viewStart formulaWidth model =
    li [ class "proof-step" ]
        ...
        , div [ class "proof-formula", style "width" <| String.fromFloat (formulaWidth / 850) ++ "em" ]
...
viewStep formulaWidth model i step =
    li [ class "proof-step" ]
        [ div [ class "proof-numbering" ] [ text <| String.fromInt (i + 1) ]
        , div [ class "proof-formula", style "width" (String.fromFloat (formulaWidth / 850) ++ "em") ]
