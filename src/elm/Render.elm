...
leftDiv shape =
    H.div [ HA.class "left-svg-box" ]
        [ shapeHtml shape
        , castHtml <| H.span [ HA.style "display" "block", HA.style "overflow" "hidden", HA.style "height" "1px", HA.style "width" "1px"  ] [ MathML.math [] (shape.mathML) ]
        ]
        ...
        , svg =
            \tr ->
                [ S.path
                    ...
                    , SA.strokeWidth (String.fromInt 40)
...
formulaShapeView shape =
    ...
    in
        H.div [ HA.class "formula-svg-box" ]
            [ svg
            , H.span [ HA.style "display" "block" , HA.style "overflow" "hidden", HA.style "height" "1px", HA.style "width" "1px" ]
...
shapeSpan shape =
    castHtml <|
        H.span [ HA.style "display" "inline-block", HA.style "position" "relative", HA.style "width" (toStr2 shape.width ++ "em") ]
            [ S.svg
                [ SA.style <|
                    "transform: scale(1,-1);"
            ...
            , H.span [ HA.style "display" "block" , HA.style "overflow" "hidden", HA.style "height" "1px", HA.style "width" "1px" ] [ MathML.math [] (shape.mathML) ]
            ]
